...
const Product = () => {
  ...
  return (
    <div className="container md:pt-20 flex gap-5 w-full items-start  mx-auto px-5 md:px-10  my-10">
      {/* filter */}
      <div
        className={`duration-300 w-[300px]  pb-24 md:pb-0 fixed md:static z-[999] top-36 ${isFilterOpen ? "left-0 " : "-left-full"} h-full overflow-y-auto ${
          isFilterOpen ? "md:w-1/4  " : "md:w-0 md:overflow-hidden"
        }`}
      >
      ...
      {/* product grid */}
      <div className={`${isFilterOpen ? "w-full md:w-3/4  " : "w-full "}`}>
